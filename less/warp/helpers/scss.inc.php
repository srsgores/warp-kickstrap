...
class scssc
{
	...
	static protected $operatorNames = array('+' => "add", '-' => "sub", '*' => "mul", '/' => "div", '%' => "mod",

		'==' => "eq", '!=' => "neq", '<' => "lt", '>' => "gt",

		'<=' => "lte", '>=' => "gte",);

	static protected $namespaces = array("special" => "%", "mixin" => "@", "function" => "^",);

	static protected $numberPrecision = 3;
	static protected $unitTable = array("in" => array("in" => 1, "pt" => 72, "pc" => 6, "cm" => 2.54, "mm" => 25.4, "px" => 96,));
	...
	protected static $lib_rgba = array(array("red", "color"), "green", "blue", "alpha");
	...
	protected static $lib_adjust_color = array("color", "red", "green", "blue", "hue", "saturation", "lightness", "alpha");
	...
	protected static $lib_change_color = array("color", "red", "green", "blue", "hue", "saturation", "lightness", "alpha");
	...
	protected static $lib_scale_color = array("color", "red", "green", "blue", "hue", "saturation", "lightness", "alpha");
...
class scss_parser
{
	static protected $precedence = array("or" => 0, "and" => 1,

		'==' => 2, '!=' => 2, '<=' => 2, '>=' => 2, '=' => 2, '<' => 3, '>' => 2,

		'+' => 3, '-' => 3, '*' => 4, '/' => 4, '%' => 4,);

	static protected $operators = array("+", "-", "*", "/", "%", "==", "!=", "<=", ">=", "<", ">", "and", "or");
	...
	protected function parseChunk()
	{
		...
		if (isset($this->buffer[$this->count]) && $this->buffer[$this->count] == "@")
		{
			...
			{
				$child = array("include", $mixinName, isset($argValues) ? $argValues : null, null);
			...
			if ($this->literal("@function") && $this->keyword($fn_name) && $this->argumentDef($args) && $this->literal("{"))
			{
