...
require_once($path . '/helpers/phpsass/SassParser.php');
...
class Warp implements ArrayAccess
{
	...
	/* branding */
	protected $_branding = 'Powered by <a href="https://github.com/srsgores/warp-kickstrap">Warp KickStrap Framework</a>';
